...
public class MyComponentResizer extends MouseAdapter{
	 ...
	 */
	public MyComponentResizer(Component... components)
	{
	 ...
	 *  @param components components to be automatically registered
	 */
	public MyComponentResizer(Insets dragInsets, Component... components)
	{
		this(dragInsets, new Dimension(1, 1), components);
	}

	/**
	 *  Create a MyComponentResizer.
	 *
	 *  @param dragInsets Insets specifying which borders are eligible to be
	 *                    resized.
	 ...
	 *  @param components components to be automatically registered
	 */
	public MyComponentResizer(Insets dragInsets, Dimension snapSize, Component... components)
	{
